...
import com.febrian.icc.databinding.ActivitySplashScreenBinding
        ...
        if (light == "Follow By System") {
            ...
            when (mode) {
                Configuration.UI_MODE_NIGHT_YES -> {
                    Glide.with(applicationContext).load(R.drawable.logo_big_white)
                        .into(binding.imgLogo)
                }
                Configuration.UI_MODE_NIGHT_NO -> {
                    Glide.with(applicationContext).load(R.drawable.logo_big_black)
                        .into(binding.imgLogo)
                }
            }
